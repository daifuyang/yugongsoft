                      ...
                      <div className="space-y-4">
                        {[
                          ...
                          <div key={i} className="flex items-center justify-between p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                            ...
                            <div className={`text-xs px-2.5 py-1 rounded ${item.status === '待派单' ? 'bg-red-100 text-red-600' :
          ...
          <div className="space-y-40">
            ...
            <FadeIn direction="left">
              <div className="flex flex-col lg:flex-row-reverse items-center gap-24">
                ...
                <div className="lg:w-1/2">
                  <PhoneMockup className="mx-auto" time="14:30">
                    {/* App Header */}
                    <div className="bg-[#1677FF] h-44 p-6 pt-6 text-white relative shrink-0 overflow-hidden">
                        ...
                        <div className="space-y-6 relative pl-2">
                          ...
                          {[
                            ...
                            <div key={i} className="flex items-center gap-4 relative group">
                              {/* Dot */}
                              <div className={`w-4 h-4 rounded-full border-[3px] shrink-0 z-10 bg-white transition-all duration-300 ${step.status === 'completed' ? 'border-[#1677FF] bg-[#1677FF]' :
                              ...
                              <div className="flex-1 flex justify-between items-center bg-white">
                                <span className={`text-sm font-medium transition-colors ${step.status === 'active' ? 'text-[#1677FF] font-bold' :
                                  step.status === 'completed' ? 'text-slate-700' : 'text-slate-400'
                                  }`}>
                                  {step.title}
                                </span>
                                <span className={`text-xs px-2 py-0.5 rounded-full ${step.status === 'active' ? 'bg-blue-50 text-blue-600' : 'bg-slate-50 text-slate-400'
                                  }`}>
                                  {step.time}
                                </span>
                              </div>
