        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="absolute -z-20 top-20 -right-20 w-full h-full bg-blue-50 rounded-xl opacity-20 scale-90"></div>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-16">
                ...
                <div className="lg:w-1/2">
                  <div className="relative bg-white rounded-2xl p-2 shadow-2xl shadow-slate-200/50 border border-white">
                    <img
                      src="/images/home/crm.jpg"
                      alt="公海池管理"
                      className="rounded-xl w-full h-auto object-cover shadow-inner"
                    />
                    {/* Decorative Elements */}
                    <div className="absolute -bottom-6 -right-6 w-40 h-40 bg-[#1677FF]/5 rounded-full blur-3xl -z-10"></div>
                  </div>
                </div>
              </div>
            </FadeIn>
                  ...
                  <div className="relative bg-white rounded-2xl p-2 shadow-2xl shadow-slate-200/50 border border-white">
                    ...
                    <div className="aspect-[4/3] bg-slate-50 rounded-xl flex items-center justify-center border border-slate-100">
                      <div className="text-center">
                        <PieChart size={64} className="text-slate-200 mx-auto mb-4" />
                        <span className="text-slate-400 text-sm">销售漏斗可视化图表</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:w-1/2 flex justify-center">
                  <div className="relative w-[280px] h-[560px] bg-slate-900 rounded-[3rem] shadow-2xl shadow-slate-400/50 border-[8px] border-slate-900 overflow-hidden">
                    ...
                    <div className="w-full h-full bg-white overflow-hidden relative">
                      <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-slate-900/50 to-transparent z-10"></div>
                      <img src="/images/home/crm.jpg" className="w-full h-full object-cover" alt="Mobile App" />
